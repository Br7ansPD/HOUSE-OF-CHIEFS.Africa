/* [forge-manifest.js] | Version: V027.003.001 | HALO-AURA CLOUD TRUTH GENERATOR */
...
function buildManifest() {
    console.log("[FORGE] Initiating Cloud Truth Omni-Scan (V027.003.001)...");
    ...
    for (const file of allFiles) {
        ...
        if (file.endsWith('.html') || file.endsWith('.js') || file.endsWith('.toml') || file.endsWith('.json')) {
            ...
            // V027.003.001 FIX: The Blindspot has been completely removed. 
