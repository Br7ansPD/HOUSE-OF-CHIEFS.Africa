...
const ZERO_TRUST_INFRASTRUCTURE = [
    ...
    'https://auth.planetcan.international/firebase-cipher-pyro-sync.js?v=V51.001.007',
    'https://auth.planetcan.international/aes256-classified-crucible-forge-cipher-pyro.js?v=V51.001.007',
    'https://auth.planetcan.international/vault-storage.js?v=V51.001.007',
